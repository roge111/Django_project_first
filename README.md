...
`admin.py` - можно настраивать то, какие таблички будут в панеле администрации.
`apps.py` - описание локальных настроек для приложения.
`models.py` - в файле мы можем создать класс, на основе которого будет создавать таблика в базе данных
